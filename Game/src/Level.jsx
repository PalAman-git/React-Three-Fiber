...
THREE.ColorManagement.legacyMode = false; //for setting the color encoding to srgb encoding we want to use color management to use modern mode not the legacy mode
...
export function BlockSpinner({ position = [0, 0, 0] }) {
  ...
  ); //for choosing random speed and direction
...
export function BlockLimbo({ position = [0, 0, 0] }) {
  ...
  const [timeOffset] = useState(() => Math.random() * Math.PI * 2); //for changing the offset of the limbos
